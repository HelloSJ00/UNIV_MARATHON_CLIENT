...
interface MileageRankingCardProps {
  runner: MileageRunner;
  isOpen: boolean;
  onToggle: () => void;
}

export default function MileageRankingCard({
  runner,
  isOpen,
  onToggle,
}: MileageRankingCardProps) {
              ...
              <div className="pt-2 border-t border-gray-200">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">총 마일리지</span>
                    <span className="font-bold text-orange-600">
                      {runner.totalDistanceKm.toFixed(1)}km
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">총 런 횟수</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono text-sm text-gray-800">
                      {runner.totalActivityCount > 0
                        ? (
                            runner.totalDistanceKm / runner.totalActivityCount
                          ).toFixed(1)
                        : "-"}
                      km
                    </span>
